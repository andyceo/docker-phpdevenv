...
ENV PIP_PACKAGES "ansible-lint ipython[notebook] matplotlib mongoengine nose numpy pandas peewee pika pymysql python-telegram-bot requests scikit-learn scipy scrapy sympy"
