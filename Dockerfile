...
ENV PIP_PACKAGES "ansible-lint autopager fake-useragent ipython[notebook] matplotlib mongoengine nose numpy pandas peewee pika pymorphy2 pymysql pysocks python-telegram-bot requests scikit-learn scipy scrapely scrapy sympy user-agents"
