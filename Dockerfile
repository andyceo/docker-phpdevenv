...
ENV GO_ARCHIVE_FILENAME go1.8.3.linux-amd64.tar.gz
ENV PIP_PACKAGES "ansible-lint autopager click fake-useragent flask influxdb ipython[notebook] matplotlib mongoengine nose numpy pandas peewee pika pymorphy2 pymysql pysocks python-telegram-bot requests scikit-learn scipy scrapely scrapy scrapy_fake_useragent scrapy_proxies stem sympy user-agents"
